                ...
                <div class="form" id="form-inserir">
                    ...
                    <div class="inputs-group">
                        <div class="input-label">
                            ...
                            <input type="date" id="adddte" value="<?php echo $deletar['logdte']; ?>">
                        </div>
                        <div class="input-label">
                            <label for="fr_tim">Hora Início</label>
                            <input id="fr_tim" type="time" value="<?php echo $deletar['fr_logtim']; ?>">
                        </div>
                        <div class="input-label">
                            <label for="to_tim">Hora Fim</label>
                            <input id="to_tim" type="time"  value="<?php echo $deletar['to_logtim']; ?>">
                        </div>
                    </div>
                    <div class="inputs-group">
                        <div class="input-label">
                            <label for="prd_id">Produto</label>
                            <input id="to_tim" type="text" value="<?php echo $deletar['prd_id']; ?>">
                        </div>
                        <div class="input-label">
                            <label for="opr_id">Operações</label>
                            <input id="to_tim" type="text" value="<?php echo $deletar['opr_id']; ?>">
                        </div>
                        <div class="input-label">
                            <label for="usrask">Solicitante</label>
                            <div>
                                <input type="text" id="usrask" placeholder="Nome"  value="<?php echo $deletar['to_usr_id']; ?>" >
                            </div>
                        </div>
                    </div>
                    <div class="inputs-group">
                        <div class="input-label">
                            ...
                            <textarea  rows="3" id="usrobs" placeholder="Observações você pode colocar aqui"><?php echo $deletar['usrobs']; ?></textarea>
                        </div>
                    </div>
                    <div>
